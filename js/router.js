export const routes = ['dashboard','ventas','facturacion','productos','inventario','traslados','proveedores','compras','cuentas-por-pagar','clientes','creditos','cartera','apartados','locales','gastos','gasolina','auditoria','usuarios','reportes','operaciones','configuracion'];
