...
import { renderProductos, productTable, productMatches } from './modules/productos.js?v=21';
...
let productViewState = { query:'', store:'all', active:'all', version:0 };
...
function clearProductFilters(){ const defaults={'[data-filter="products"]':'','[data-product-store]':'all','[data-product-active]':'all'};Object.entries(defaults).forEach(([selector,value])=>{const element=$(selector);if(element)element.value=value;});productPage=1;refreshProducts();}
